...
public class GameSounds {
    ...
    public GameSounds() {
        ...
        playSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/playsound.mp3"); //file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/coinsound.mp3
        playSound = new MediaPlayer(playSound_media);
        playSound.setCycleCount(playSound.INDEFINITE);
        playSound.setVolume(0.1);
        
        menuSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/menusound.mp3");
        menuSound = new MediaPlayer(menuSound_media);
        menuSound.setCycleCount(menuSound.INDEFINITE);
        menuSound.setVolume(0.1);
       
        jumpSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/jumpsound.mp3");
        jumpSound = new MediaPlayer(jumpSound_media);
        jumpSound.setVolume(0.5);
        
        coinSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/coinsound.mp3");
        coinSound = new MediaPlayer(coinSound_media);
        coinSound.setVolume(0.5); 
           
        winSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/winsound.mp3");
        winSound = new MediaPlayer(winSound_media);
        winSound.setVolume(0.5);
       
        
        loseSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/losesound.mp3");
        loseSound = new MediaPlayer(loseSound_media);
        loseSound.setVolume(0.5);
       
        
        fallSound_media = new Media("file:///D:/courses/JAVA/Java%20Project/project/Super-Mario-JavaFx-/Super-Mario/src/sounds/fallsound.mp3");
